...
export const site = {
  ...
  seo: {
    ...
    description:
      'BetaWeb designs and builds fast, modern websites for small businesses in Canada — premium quality without agency-level prices. Plans from $97/month.',
    ogDescription:
...
export const trust = {
  ...
  stats: [
    ...
    { icon: 'dollar', label: 'Affordable', value: 'From $97/mo' },
  ],
};
...
export const pricing = {
  ...
  subtitle: 'Choose a one-time build or spread the cost with a monthly plan.',
  trustLine: 'Fixed pricing. No hidden fees. No surprise invoices.',
  noUpfrontBanner: {
    eyebrow: 'No Upfront Option',
    title: 'Professional website from $97/month',
    subtitle: 'No large upfront investment.',
  ...
  tiers: [
    {
      ...
      price: '$499',
      priceNote: 'one-time',
      desc: 'Everything you need to establish a professional online presence.',
      features: [
        'Up to 2 pages',
        'A modern, mobile-friendly website',
        'Help customers find and contact you',
        'Never miss an enquiry with a built-in contact form',
        'Fast loading and easy to navigate',
        'Domain & launch assistance',
        '14 days of post-launch support',
      ],
      perfectFor: 'Perfect for businesses getting online for the first time.',
      cta: 'Get started',
      highlighted: false,
    },
    {
      ...
      price: '$899',
      priceNote: 'one-time',
      desc: 'Built for businesses that want to generate leads and grow.',
      features: [
        'Everything in Essential',
        'Premium custom design',
        'Up to 5 pages',
        'Turn visitors into customers with lead capture forms',
        'Instant email notifications for new enquiries',
        'SEO-ready structure to help customers find you online',
        'Unlimited minor changes during the first 14 days',
        '30 days post-launch support',
      ],
      perfectFor: 'Perfect for businesses ready to grow their customer base.',
      cta: 'Get started',
      highlighted: true,
      badge: 'Most popular',
    },
    {
      ...
      price: 'Custom',
      priceNote: 'quote',
      desc: 'For businesses that need advanced functionality.',
      features: [
  ...
  noUpfrontPlan: {
    name: 'No Upfront Option',
    price: '$97',
    priceNote: '/month',
    upfrontNote: '$0 upfront',
    desc: 'Get your website with no large initial investment.',
    features: [
...
export const faq = {
  ...
  items: [
    ...
    },
    {
      ...
      a: 'Yes — our Monthly Care Plans start at $29/month and include hosting, domain renewal, security, maintenance, and ongoing support. You\'re also free to host elsewhere.',
    },
    {
    ...
    },
    {
      ...
      a: 'Only if you choose one. You can pay upfront for Essential, Business, or Premium — or spread the cost with our No Upfront Option from $97/month. Monthly Care Plans for hosting and support are optional add-ons starting at $29/month.',
    },
    {
